...
<style>
    ...
    --button-bg: #666666; /* Dark button background color */
    --button-text: #DDDDDD; /* Dark button text color */
    --table-header-bg: #444444; /* Dark table header background */
    --table-padding-bg: #333333; /* Dark background color for table padding */
    }
...
@media (max-width: 768px) {
  ...
  .dropdown-container, .export-button-container, .database-container {
    margin-top: 20px;
  }
    ...
    background-color: var(--table-padding-bg); /* Ensure the padding background also changes */
    }

    th, td {
    padding: 8px;
    text-align: center;
    background-color: var(--table-header-bg); /* Separate variable for header background */
    }
...
<div class="report-container">
    <Heading tag="h1" class="mb-4 text-3xl text-center font-extrabold md:text-5xl lg:text-6xl gradient heading">
        REPORTS
    </Heading>
